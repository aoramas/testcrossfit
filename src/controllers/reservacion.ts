...
const getBookings = async (req: Request, res: Response) => {
  const rta = await Reservacion.findAll();
  res.json(rta);
};
...
const getBookingsById = async (req: Request, res: Response) => {
  const { id } = req.params;
  const rta = await Reservacion.findOne({ where: { id } });
  res.json(rta);
};
...
const createBookings = async (req: Request, res: Response) => {
  const { body } = req;
  const rta = await Reservacion.create(body);
  res.json(rta);
};
...
const updateBookings = async (req: Request, res: Response) => {
  const { body } = req;
  const { id } = req.params;
  const rta = await Reservacion.update(body, { where: { id } });
  res.json(rta);
};
...
const deleteBookings = async (req: Request, res: Response) => {
  const { id } = req.params;
  const rta = await Reservacion.destroy({ where: { id } });
  res.json(rta);
};
